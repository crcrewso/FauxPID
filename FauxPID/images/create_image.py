...
class ImageGenerator:
    ...
    def generate_winston_lutz_images(self):
        ...
        dir_1mm_out = dir_path / "1mm_out"
        dir_1mm_out.mkdir(parents=True, exist_ok=True)

        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(1, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_045.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.image = ndimage.rotate(simulator_instance.image, 45, reshape=False, mode='nearest')
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(1, 0)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=45.0, patient_support_angle=0.0)
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_090.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_135.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_225.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_270.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_coll_315.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_couch_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_couch_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_couch_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_couch_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_couch_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_135.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_180.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_225.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_1mm_out / "winston_lutz_1mm_out_gantry_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        dir_complex = dir_path / "complex (2, 3, 6)"
        dir_complex.mkdir(parents=True, exist_ok=True)

        file_path = dir_complex / "winston_lutz_complex_couch_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 2)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_couch_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3.536, -0.717)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_couch_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-2, -3)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_couch_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_couch_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-0.717, 3.536)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 5.657)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 6)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_135.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 2.828)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_180.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_225.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_gantry_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_coll_000.dcm" 
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 2)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=0.0, patient_support_angle=0.0)
        if self.include_png:
            plt.imsave(file_path.with_suffix('.png'), simulator_instance.image)

        file_path = dir_complex / "winston_lutz_complex_coll_045.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_coll_090.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_coll_135.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_coll_225.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_coll_270.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_complex_coll_315.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        dir_complex = dir_path / "wobble"
        dir_complex.mkdir(parents=True, exist_ok=True)

        file_path = dir_complex / "winston_lutz_wobble_couch_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-2, 2)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_couch_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-4.536, -0.717)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_couch_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-2.707, -3.707)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_couch_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_wobble_couch_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-0.717, 4.536)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3.21, 6.634)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-2, 6)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_135.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-4, 2.828)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_180.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, -1)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_225.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-2.293, -5.050)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, -5)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_gantry_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, -1.828)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_000.dcm" 
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3.707, 2.293)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=0.0, patient_support_angle=0.0)
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_045.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_090.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.image = ndimage.rotate(simulator_instance.image, 90, reshape=False, mode='nearest')
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3.707, 2.707)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=90.0, patient_support_angle=0.0)
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_135.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.image = ndimage.rotate(simulator_instance.image, 135, reshape=False, mode='nearest')
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 3)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=135.0, patient_support_angle=0.0)
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_225.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.image = ndimage.rotate(simulator_instance.image, 225, reshape=False, mode='nearest')
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3, 1)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=225.0, patient_support_angle=0.0)
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_270.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.image = ndimage.rotate(simulator_instance.image, 270, reshape=False, mode='nearest')
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-2.03, 2.21)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=270.0, patient_support_angle=0.0)
        ...
        file_path = dir_complex / "winston_lutz_wobble_coll_315.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        simulator_instance.image = ndimage.rotate(simulator_instance.image, 315, reshape=False, mode='nearest')
        simulator_instance.add_layer(layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(-3.5, 2.866)))
        simulator_instance.add_layer(layers.RandomNoiseLayer())
        simulator_instance.add_layer(layers.GaussianFilterLayer(sigma_mm=2))
        simulator_instance.generate_dicom(file_out_name=file_path, gantry_angle=0)
        add_metadata(file_path, gantry_angle=0.0, beam_limiting_device_angle=315.0, patient_support_angle=0.0)
        ...
        dir_complex = dir_path / "outlier"
        dir_complex.mkdir(parents=True, exist_ok=True)

        file_path = dir_complex / "winston_lutz_outlier_couch_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_couch_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_couch_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_couch_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_couch_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_000.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_045.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_090.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_135.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_180.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_225.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_270.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_gantry_315.dcm"
        field_layers = [
            layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
            ...
            layers.PerfectBBLayer(alpha=-0.5, bb_size_mm=6, cax_offset_mm=(2, -2.828)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(53, 0)),
            layers.PerfectFieldLayer(field_size_mm=(56, 2), alpha=0.5, cax_offset_mm=(-53, 0)),
        ]
        initial_offset = 25
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_000.dcm" 
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_045.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_090.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_135.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_225.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_270.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
        ...
        file_path = dir_complex / "winston_lutz_outlier_coll_315.dcm" #Using add layer because rotations are not supported
        simulator_instance = self.simulator(sid=self.sid)
        simulator_instance.add_layer(layers.FilteredFieldLayer(
                field_size_mm=(50, 50),
                alpha=0.9,
